...
CREATE TABLE SUBLOCATION (
    ...
    CREATE_DATE         DATE DEFAULT SYSDATE,
    LAST_MODIFIED       DATE DEFAULT SYSDATE,
CONSTRAINT SUBLOC_PK PRIMARY KEY (SUBLOCATION_ID),
CONSTRAINT SUBLOC_FK1 FOREIGN KEY (LOCATION_ID) REFERENCES LOCATION(LOCATION_ID));
...
CONSTRAINT MED_FK1 FOREIGN KEY (PARENT_MEDIUM_ID) REFERENCES MEDIUM(MEDIUM_ID));
